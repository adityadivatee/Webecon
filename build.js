   ...
   ╚══╝╚══╝ ╚══════╝╚═════╝ ╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝
    ...
    [distDir, sdkBase].forEach(dir => {
        try {
            ...
            console.warn(`⚠️ Could not completely remove ${dir} (it may be open in a terminal). Overwriting instead.`);
        }
