...
## 🚀 Installation
Include `Webecon.php` in your project's source directory, or install via package manager if applicable.

## 🛠️ Quick Usage
```php
$tag = Webecon::icon("zap")->size(48)->theme("neon")->build();
```
