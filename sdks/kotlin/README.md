# Webecon Kotlin SDK (v17.2.8 PRO)
...
## 🚀 Installation
Include `com\adityadivte\Webecon\Webecon.kt` in your project's source directory, or install via package manager if applicable.
