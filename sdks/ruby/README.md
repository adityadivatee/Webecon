...
## 🚀 Installation
Include `webecon.rb` in your project's source directory, or install via package manager if applicable.

## 🛠️ Quick Usage
```ruby
tag = Webecon::Icon.icon("zap").size(48).build
```
