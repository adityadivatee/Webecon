...
def check_updates():
    ...
    try:
        with urllib.request.urlopen("https://api.github.com/repos/adityadivatee/Webecon/releases/latest", timeout=2) as r:
            ...
            if latest > "17.2.8":
                print(f"\n\033[96m🚀 New Webecon version available: v{latest} (Current: v17.2.8)\033[0m")
