...
(function(){const icons={
    ...
    'twitch': `<path d="M4 5v11a1 1 0 0 0 1 1h2v4l4 -4h5.584c.266 0 .52 -.105 .707 -.293l2.415 -2.414c.187 -.188 .293 -.442 .293 -.708v-8.585a1 1 0 0 0 -1 -1h-14a1 1 0 0 0 -1 1z"/><path d="M16 8l0 4"/><path d="M12 8l0 4"/>`,
    ...
    // Social Media
    'reddit': `<path d="M12 8c2.648 0 5.028 .826 6.675 2.14a2.5 2.5 0 0 1 2.326 4.36c0 3.59 -4.03 6.5 -9 6.5c-4.875 0 -8.845 -2.8 -9 -6.294l-1 -.206a2.5 2.5 0 0 1 2.326 -4.36c1.646 -1.313 4.026 -2.14 6.674 -2.14l.999 0"/><path d="M12 8l1 -5l6 1"/><path d="M18 4a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/><path d="M8.5 13a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0"/><path d="M14.5 13a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0"/><path d="M10 17c.667 .333 1.333 .5 2 .5s1.333 -.167 2 -.5"/>`,
    'slack': `<rect width="3" height="8" x="13" y="2" rx="1.5"/><path d="M19 8.5v1a1.5 1.5 0 0 1-3 0v-1a1.5 1.5 0 0 1 3 0z"/><rect width="3" height="8" x="8" y="14" rx="1.5"/><path d="M5 15.5v-1a1.5 1.5 0 0 1 3 0v1a1.5 1.5 0 0 1-3 0z"/><rect width="8" height="3" x="14" y="13" rx="1.5"/><path d="M15.5 19h-1a1.5 1.5 0 0 1 0-3h1a1.5 1.5 0 0 1 0 3z"/><rect width="8" height="3" x="2" y="8" rx="1.5"/><path d="M8.5 5h1a1.5 1.5 0 0 1 0 3h-1a1.5 1.5 0 0 1 0-3z"/>`,
    ...
    'snapchat': `<path d="M16.182 16.694c1.7 .306 3.818 1.306 3.818 1.306c0 .53 -.5 1 -.5 1c-1.5 0 -5.029 -1 -7.5 -1c-2.471 0 -6 1 -7.5 1c0 0 -.5 -.47 -.5 -1c0 0 2.118 -1 3.818 -1.306c0 0 1.761 -1.989 1.583 -3.181c-.5 -.5 -.8 -1.82 -.8 -1.82s-.986 -.077 -.986 -1.13c0 -.482 .322 -1.41 .772 -1.41c0 0 -.24 -2.573 .654 -4.137c.783 -1.371 1.84 -2.016 2.959 -2.016c1.12 0 2.176 .645 2.96 2.016c.893 1.564 .653 4.137 .653 4.137c.45 0 .772 .928 .772 1.41c0 1.053 -.986 1.13 -.986 1.13s-.3 1.32 -.8 1.82c-.178 1.192 1.583 3.181 1.583 3.181z"/><path d="M10.5 20.5l1.5 .5l1.5 -.5"/>`,
    'pinterest': `<path d="M8 20l4 -9"/><path d="M10.7 14c.437 1.263 1.43 2 2.55 2c2.071 0 3.75 -1.554 3.75 -4a5 5 0 1 0 -9.7 1.7"/><path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"/>`,
    'tumblr': `<path d="M10 21c-2 0-3-1-3-3v-7H5V7h2V3h4v4h4v4h-4v6c0 1 1 1 2 1h1v4h-4z"/>`,
    'medium': `<path d="M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -12"/><path d="M8 9h1l3 3l3 -3h1"/><path d="M8 15l2 0"/><path d="M14 15l2 0"/><path d="M9 9l0 6"/><path d="M15 9l0 6"/>`,
    'dev-to': `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M6 15V9h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6z"/><path d="M14 9h-3v6h3"/><path d="M11 12h2"/><path d="M15 9l1.5 6L18 9"/>`,
    'quora': `<path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z"/><path d="M16 16l4 4"/>`,
    'reddit-brand': `<path d="M12 8c2.648 0 5.028 .826 6.675 2.14a2.5 2.5 0 0 1 2.326 4.36c0 3.59 -4.03 6.5 -9 6.5c-4.875 0 -8.845 -2.8 -9 -6.294l-1 -.206a2.5 2.5 0 0 1 2.326 -4.36c1.646 -1.313 4.026 -2.14 6.674 -2.14l.999 0"/><path d="M12 8l1 -5l6 1"/><path d="M18 4a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/><path d="M8.5 13a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0"/><path d="M14.5 13a.5 .5 0 1 0 1 0a.5 .5 0 1 0 -1 0"/><path d="M10 17c.667 .333 1.333 .5 2 .5s1.333 -.167 2 -.5"/>`,
