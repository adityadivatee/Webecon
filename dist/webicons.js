/**
 * Webecon - Premium Animated Icon Engine v17.2.6 PRO
...
(function(){const icons={
    ...
    'whatsapp': `<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/><path d="M16.5 13.5c-.8.8-2 .8-2.8 0l-3.4-3.4c-.8-.8-.8-2 0-2.8.8-.8 2-.8 2.8 0l.6.6c.8.8.8 2 0 2.8l-1.4 1.4c.4.8 1 1.6 1.8 2l1.4-1.4c.8-.8 2-.8 2.8 0l.6.6c.8.8.8 2 0 2.8z"/>`,
    ...
    'snapchat': `<path d="M12 3c-4 0-6 3-6 6 0 2 1 3 1 3s-2 1-2 3c0 2 3 3 3 3s1 2 4 2 4-2 4-2 3-1 3-3c0-2-2-3-2-3s1-1 1-3c0-3-2-6-6-6z" fill="currentColor" stroke="none"/>`,
    'pinterest': `<circle cx="12" cy="12" r="10"/><path d="M12 6c0 3-1 5-2 9l-1 3m1-12c4 0 4 6 4 6s0 3-2 3" fill="currentColor" stroke="none"/>`,
    'tumblr': `<path d="M10 21c-2 0-3-1-3-3v-7H5V7h2V3h4v4h4v4h-4v6c0 1 1 1 2 1h1v4h-4z" fill="currentColor" stroke="none"/>`,
    'medium': `<ellipse cx="6" cy="12" rx="4" ry="8"/><ellipse cx="14" cy="12" rx="2" ry="6"/><ellipse cx="20" cy="12" rx="1" ry="4"/>`,
    'dev-to': `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 8v8h2v-3h2v-2H9V8H7zm7 0v8h5v-2h-3v-1h2v-2h-2v-1h3V8h-5z" fill="currentColor" stroke="none"/>`,
    'quora': `<circle cx="12" cy="12" r="8"/><path d="M12 16s4-4 4-8-4-4-4-4"/><path d="M14 18l4 4"/>`,
    'reddit-brand': `<path d="M12 8c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2"/><path d="M12.4 6c.9 1 2.4 1.3 3.6 1.1"/><path d="M16 11c0-1.1-.9-2-2-2s-2 .9-2 2c0 1.1.9 2 2 2 .4 0 .8-.1 1.1-.3"/><path d="M8 11c0-1.1-.9-2-2-2s-2 .9-2 2c0 1.1.9 2 2 2 .4 0 .8-.1 1.1-.3"/><path d="M10 16c0 1.1.9 2 2 2s2-.9 2-2"/><path d="M12 22c5.5 0 10-4.5 10-10s-4.5-10-10-10S2 6.5 2 12s4.5 10 10 10z"/>`,
